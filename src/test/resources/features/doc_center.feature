...
Scenario: : Navigate to URL
  ...
  Scenario: Successful login
    Given we enter value on page login locator username value "auto"
    ...
    Then we capture screenshot on page login locator body name "doc_center/screenshot"
